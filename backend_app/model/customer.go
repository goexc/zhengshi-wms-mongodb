...
type Customer struct {
	...
	Type                          string             `json:"type" bson:"type"`                                                         //客户类型：个人、企业、组织
	Code                          string             `json:"code" bson:"code"`                                                         //客户编号：分配给客户的唯一标识符或编号，用于快速识别和检索客户信息
	Image                         string             `json:"image" bson:"image"`                                                       //客户图片
	...
	ReceivableBalance float64            `json:"receivable_balance" bson:"receivable_balance"` //应收账款余额
