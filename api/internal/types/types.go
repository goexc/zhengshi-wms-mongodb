...
type FastOutboundMaterial struct {
	MaterialId string  `json:"material_id,optional" validate:"required,mongodb"`  // 物料Id
	Price      float64 `json:"price,optional" validate:"number,gte=0"`            // 单价
	Quantity   float64 `json:"quantity,optional" validate:"required,number,gt=0"` // 出库数量
}
...
type MaterialDeliveryRebuildTaskPageResponse struct {
	Code int                                 `json:"code"` // 响应状态码
	Msg  string                              `json:"msg"`  // 响应消息
	Data MaterialDeliveryRebuildTaskPaginate `json:"data"` // 分页数据
}

type MaterialDeliveryRebuildTaskPaginate struct {
	Total int64                         `json:"total"` // 总数
	List  []MaterialDeliveryRebuildTask `json:"list"`  // 重建任务列表
}

type MaterialDeliveryRebuildTaskRequest struct {
...
type MaterialDeliveryRebuildTaskResponse struct {
	Code int                         `json:"code"` // 响应状态码
	Msg  string                      `json:"msg"`  // 响应消息
...
type MaterialQuotePageResponse struct {
	Code int                   `json:"code"` // 响应状态码
	Msg  string                `json:"msg"`  // 响应消息
	Data MaterialQuotePaginate `json:"data"` // 分页数据
}

type MaterialQuotePaginate struct {
	Total int64           `json:"total"` // 总数
