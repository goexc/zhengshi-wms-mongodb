...
func (l *AddLogic) Add(req *types.OutboundReceiptAddRequest) (resp *types.BaseResponse, err error) {
	...
	count, err := l.svcCtx.OutboundReceiptModel.CountDocuments(l.ctx, filter)
	if err != nil {
	...
	_, err = l.svcCtx.OutboundReceiptModel.InsertOne(l.ctx, &receipt)
	if err != nil {
