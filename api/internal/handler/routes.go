...
import (
	...
	materialquote "api/internal/handler/material/quote"
	...
	server.AddRoutes(
		[]rest.Route{
			...
			},
			{
				...
				Method:  http.MethodGet,
				Path:    "/new_delivery",
				Handler: material.NewDeliveryHandler(serverCtx),
			},
			{
				// 导出客户新增物料报价
				Method:  http.MethodPost,
				Path:    "/new_delivery/quote/export",
				Handler: material.ExportNewDeliveryQuoteHandler(serverCtx),
			},
			{
				// 重建客户物料首次交付记录
				Method:  http.MethodPost,
				Path:    "/new_delivery/rebuild",
				Handler: material.RebuildDeliveryHandler(serverCtx),
			},
			{
				// 最近一次客户物料首次交付重建任务
				Method:  http.MethodGet,
				Path:    "/new_delivery/rebuild/latest",
				Handler: material.LatestRebuildDeliveryTaskHandler(serverCtx),
			},
			{
				// 客户物料首次交付重建任务列表
				Method:  http.MethodGet,
				Path:    "/new_delivery/rebuild/tasks",
				Handler: material.RebuildDeliveryTasksHandler(serverCtx),
			},
		},
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
		...
		[]rest.Route{
			{
				...
				Method:  http.MethodPost,
				Path:    "/",
				Handler: materialquote.AddHandler(serverCtx),
			},
			{
				// 保存物料报价单
				Method:  http.MethodPut,
				Path:    "/",
				Handler: materialquote.UpdateHandler(serverCtx),
			},
			{
				// 物料报价单分页
				Method:  http.MethodGet,
				Path:    "/",
				Handler: materialquote.PageHandler(serverCtx),
			},
			{
				// 导出物料报价
				Method:  http.MethodPost,
				Path:    "/export",
				Handler: materialquote.ExportHandler(serverCtx),
			},
			{
				// 物料报价单详情
				Method:  http.MethodGet,
				Path:    "/info",
				Handler: materialquote.InfoHandler(serverCtx),
			},
			{
				// 报价转最终定价
				Method:  http.MethodPost,
				Path:    "/price",
				Handler: materialquote.PriceHandler(serverCtx),
			},
			{
				// 提交物料报价
				Method:  http.MethodPost,
				Path:    "/submit",
				Handler: materialquote.SubmitHandler(serverCtx),
			},
			{
				// 作废物料报价
				Method:  http.MethodPatch,
				Path:    "/void",
				Handler: materialquote.VoidHandler(serverCtx),
			},
		},
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
		rest.WithPrefix("/material/quote"),
	)
	...
	server.AddRoutes(
		[]rest.Route{
			...
			},
			{
				...
				Method:  http.MethodPost,
				Path:    "/fast_departure",
				Handler: outbound.FastDepartureHandler(serverCtx),
			},
			{
				// 出库单物料列表
				Method:  http.MethodGet,
