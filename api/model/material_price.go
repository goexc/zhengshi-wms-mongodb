...
type MaterialPrice struct {
	...
	SourceType          string `json:"source_type" bson:"source_type"`                     // 来源类型：manual、outbound、material_quote
	SourceQuoteId       string `json:"source_quote_id" bson:"source_quote_id"`             // 来源报价单id
	SourceDeliveryId    string `json:"source_delivery_id" bson:"source_delivery_id"`       // 来源客户新增物料记录id
	SourceValid         bool   `json:"source_valid" bson:"source_valid"`                   // 来源是否有效
