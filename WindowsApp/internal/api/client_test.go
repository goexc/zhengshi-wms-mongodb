...
func TestClientSendsCompleteFilterContracts(t *testing.T) {
	...
	_, _ = client.InboundReceipts(context.Background(), 1, 20, InboundFilters{
		Code: "RK-001", Status: "在途", Type: "采购入库", SupplierID: "supplier",
	})
	...
	want := []string{
		...
		"/inbound/receipt?code=RK-001&page=1&size=20&status=%E5%9C%A8%E9%80%94&supplier_id=supplier&type=%E9%87%87%E8%B4%AD%E5%85%A5%E5%BA%93",
	}
